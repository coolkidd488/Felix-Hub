...
Criar("TextLabel",{Text="DOORS EDITION  v2.6",Font=Enum.Font.Gotham,
...
local function Abrir()
    Open=true; Win.Visible=true
    -- Reseta tamanho antes de animar (evita posição errada)
    Win.Size=UDim2.new(0,WIN_W,0,WIN_H)
    Win.Position=UDim2.new(0,WIN_X,0,WIN_Y)  -- sempre abre na esquerda
    -- Anima só a transparência de fundo, não o tamanho
    Win.BackgroundTransparency=1
    TW(Win,TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
...
task.delay(0.6,function()
    Notif("⚡ Felix Hub v2.6","Carregado! Clique no F ou RCtrl.",5)
end)
print("[FelixHub] v2.6 carregado!")
