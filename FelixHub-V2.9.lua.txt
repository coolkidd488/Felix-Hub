...
local function ScanLivros()
        ...
        for _,o in ipairs(game:GetDescendants()) do
            if o and o.Name == "LiveHintBook" then
                ...
                if not Cache[uid] then
                    Cache[uid] = true
                    Estado.LivrosN = Estado.LivrosN + 1
                    pcall(ESP, o, Cfg.cLivro, "LIVRO "..Estado.LivrosN.."/8")
                    Log("Livro " .. Estado.LivrosN .. " encontrado: " .. uid)
    ...
    Log("Scan concluido. Total LiveHintBook: " .. total)
    if total == 0 then
